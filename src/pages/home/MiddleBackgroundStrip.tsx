...
export default function MiddleBackgroundStrip() {
  ...
  return (
    <Paper elevation={3} sx={{ marginBottom: "0.5%" }}>
      <Box
        // height="100px"
        // width="100px"
        sx={{
            ...
            <Grid item xs={12} lg={8} id="home-text-grid">
              <Box sx={{ textAlign: "left" }}>
                <Typography variant="body1">
                  The ruler of Dubai commemorated the year 2023 as "
                  ...
                  <br />
                  <br />
                  Women’s Sustainability Network at its core recognizes the
                  value and contribution in every aspect that women bring to the
                  table, in creating and sustaining families, developing and
                  serving businesses, and influencing society.
                </Typography>
              </Box>
            </Grid>
